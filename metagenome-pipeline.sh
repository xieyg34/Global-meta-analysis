##Read metagenomic samples, perform quality control, remove hosts, assemble, and remove redundancy.
cat ID|while a;do
...
##Annotation of antibiotic resistance genes using the ARGs-OAP pipeline
args_oap stage_one -i 06-cd-hit -o 06-args  -f fa -t 8
args_oap stage_two -i 08-args -t 8

##Annotating antibiotic resistance gene risk levels using the arg_ranker pipeline
